...
public:
    static constexpr std::size_t kMaxProbeLen = 3;
...
public:
    ...
    void start(const void* probe_data, std::size_t probe_len);
...
private:
    ...
    void try_to_connect_by_iterator(asio::ip::udp::resolver::results_type::const_iterator iter);
...
protected:
    ...
    std::uint8_t probe_head[kMaxProbeLen] = { 0 };
    SocksVersion ver;
    uint8_t rsv;
